...
void loop() {
  ...
  if(any_event) {
    ...
    // matricea sus
    sprintf(line, "      %d %d %d      \n\r", sus[0][0], sus[0][1], sus[0][2]);
    Serial.print(line);
    sprintf(line, "      %d %d %d      \n\r", sus[1][0], sus[1][1], sus[1][2]);
    Serial.print(line);
    sprintf(line, "      %d %d %d      \n\r", sus[2][0], sus[2][1], sus[2][2]);
    Serial.print(line);

    
    // matricile stanga, fata si dreapta
    sprintf(line, "%d %d %d %d %d %d %d %d %d\n\r", stanga[0][0], stanga[0][1], stanga[0][2], fata[0][0], fata[0][1], fata[0][2], dreapta[0][0], dreapta[0][1], dreapta[0][2]);
    Serial.print(line);
    sprintf(line, "%d %d %d %d %d %d %d %d %d\n\r", stanga[1][0], stanga[1][1], stanga[1][2], fata[1][0], fata[1][1], fata[1][2], dreapta[1][0], dreapta[1][1], dreapta[1][2]);
    Serial.print(line);
    sprintf(line, "%d %d %d %d %d %d %d %d %d\n\r", stanga[2][0], stanga[2][1], stanga[2][2], fata[2][0], fata[2][1], fata[2][2], dreapta[2][0], dreapta[2][1], dreapta[2][2]);
    Serial.print(line);

    //matricea jos
    sprintf(line, "      %d %d %d      \n\r", jos[0][0], jos[0][1], jos[0][2]);
    Serial.print(line);
    sprintf(line, "      %d %d %d      \n\r", jos[1][0], jos[1][1], jos[1][2]);
    Serial.print(line);
    sprintf(line, "      %d %d %d      \n\r", jos[2][0], jos[2][1], jos[2][2]);
    Serial.print(line);
    
    //matricea spate
    sprintf(line, "      %d %d %d      \n\r", spate[0][0], spate[0][1], spate[0][2]);
    Serial.print(line);
    sprintf(line, "      %d %d %d      \n\r", spate[1][0], spate[1][1], spate[1][2]);
    Serial.print(line);
    sprintf(line, "      %d %d %d      \n\n\n\r", spate[2][0], spate[2][1], spate[2][2]);
    Serial.print(line);
  }
